...
import knifeJett from "../../assets/img/knifeJett.webp" 
import Jett from "../../assets/img/Jett2.png" 
...
export const Body = styled.div`
  ...
  position:relative;
  overflow:hidden;
  background: url(${Jett}) no-repeat center /100% 100%;
`
...
export const Cabin = styled.div`
  background: url(${knifeJett}) no-repeat center ;
  margin:0;
