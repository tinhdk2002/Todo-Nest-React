...
import Logo from "../assets/QSage.webp";
...
const NavBar = () => {
  ...
  return (
    <nav className="flex items-center justify-between flex-wrap bg-blue-400 py-4 lg:px-12 shadow border-solid border-t-2 border-blue-700">
